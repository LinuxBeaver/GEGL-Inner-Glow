...
property_string (string, _("Black"), TUTORIAL)
...
#define GEGL_OP_META
#define GEGL_OP_NAME     zzblack
#define GEGL_OP_C_SOURCE zzblack.c
...
gegl_op_class_init (GeglOpClass *klass)
{
  ...
  gegl_operation_class_set_keys (operation_class,
    "name",        "gegl:zzeraseblack",
    "title",       _("zzeraseblack"),
    "categories",  "hidden",
    "reference-hash", "29b152211f0aagh87ba97b41d8d4e",
